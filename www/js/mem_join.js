$(document).ready(function(){
		...
		$('#frmJoin').validate({
			rules: {
				mb_id : { required:true ,DoubleIdCheck:true} ,
			...
			messages: {
				...
				//mb_birth: { required: "생년월일을 입력하세요", minlength: $.format("생년월일은 {0}자 이상 입력하세요") ,maxlength: $.format("생년월일은 {0}자 이하로 입력하세요")},
				mb_mobile1: { required: "휴대전화 번호를 선택하세요"},
				mb_mobile2: { required: "휴대전화 번호를 입력하세요", minlength: $.format("휴대전화 번호는 {0}자 이상 입력하세요") ,maxlength: $.format("휴대전화 번호는 {0}자 이하로 입력하세요")},
				mb_mobile3: { required: "휴대전화 번호를 입력하세요", minlength: $.format("휴대전화 번호는 {0}자 이상 입력하세요") ,maxlength: $.format("휴대전화 번호는 {0}자 이하로 입력하세요")},
