			...
			<form name="l_form" id="l_form" method="post">
				<input type="hidden" name="mode" value="mem" />
                    <ul class="entry-section">
                        <li class="required"><input type="text" id="m_id" name="m_id" required placeholder="아이디" value="{m_id}"/></li>
                        <li class="required"><input type="password" id="pwd" name="pwd" required placeholder="비밀번호" /></li>
                        <li>
                            <label class="check-label"><input type="checkbox" value="Y" id="" name="rem_info" {?rem_yn}checked{/} /><span>아이디기억</span></label>
