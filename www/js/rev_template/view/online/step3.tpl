<header id="header">
	...
	<form id="pForm" method="post">
		...
		<input type="hidden" id="r_phone" name="p_phone" value="{p_phone}" />
	    <input type="hidden" id="r_name" name="p_name" value="{p_name}" />
	    <input type="hidden" id="r_birth" name="p_birth" value="{p_birth}" />
	    <input type="hidden" id="r_sex" name="p_sex" value="{p_sex}" />    
        <input type="hidden" id="t_code" name="t_code" value="{t_code}" />  
        <input type="hidden" id="t_code_name" name="t_code_name" value="{t_code_name}" /> 
