	...
	<form name="r_form" id="r_form" method="post">
		...
		<input type="hidden" name="kakao_token" value="{kakao_token}"/> 
		<input type="hidden" name="kakao_re_token" value="{kakao_re_token}"/>       
		<input type="hidden" name="r_id" value="{r_id}"/>
		<input type="hidden" name="r_nick" value="{nick}"/>
		<input type="hidden" name="r_pro_image" value="{pro_image}"/>
		<input type="hidden" name="r_thum_image" value="{thum_image}"/>
		<input type="hidden" name="r_info" value="{r_info}"/>
        <input type="hidden" name="r_phone1" value="{r_phone1}" id="r_phone1"/>
				...
				<ul>
					...
					<li>
						<div class="select-layout top">
							<a href="javascript:void(0)" class="trigger" id="r_phone">010</a>
							<ul class="list">
...
<script language="javascript">        
	$("#btn_confirm").click(function(){
		...
		$("#r_phone1").val($("#r_phone").data("value"));
