...
//$helper = new Kakao_REST_API_Helper('9821ebf5f096a00469683033d1ba1abf');
//$helper->set_admin_key('2131b9268caa6178f3c6107431be8b26');
...
class Kakao_REST_API_Helper
{
  ...
  private $REST_KEY = '9821ebf5f096a00469683033d1ba1abf';  // 디벨로퍼스의 앱 설정에서 확인할 수 있습니다.
  private $REDIRECT_URI = '/'; // 설정에 등록한 사이트 도메인 + redirect uri
