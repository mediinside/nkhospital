...
class Template_
{
	...
	var $compile_dir   = '../m/template_file/_compile';
	var $compile_ext   = 'php';
	var $skin          = '';
	var $notice        = false;
	var $path_digest   = false;

	var $template_dir  = '../m/template_file/_template';
	var $prefilter     = '';
	var $postfilter    = '';
	var $permission    = 0777;
	var $safe_mode     = false;
	...
	function _get_compile_path($rpath)
	{
		...
		$cpl_head = '<?php /* Template_ 2.2.7 '.date('Y/m/d H:i:s', filemtime($tpl_path)).' '.$tpl_path.' ';
