<?php /* Template_ 2.2.7 2016/09/08 15:28:36 /home/hosting_users/nkmed/www/rev_template/view/online/step2.tpl 000004083 */ ?>
<header id="header">
...
<script language="javascript">
	$("#same_member").click(function(){
		if($("#same_member").is(":checked") == true) {
			$("#p_name").val("<?php echo $TPL_VAR["p_name"]?>");
			$("#p_birth").val("<?php echo $TPL_VAR["r_birth"]?>");
			$("#p_phone1").html("<?php echo $TPL_VAR["p_phone1"]?>");
			$("#p_phone2").val("<?php echo $TPL_VAR["p_phone2"]?>");
			$("#p_phone3").val("<?php echo $TPL_VAR["p_phone3"]?>");
