<?php /* Template_ 2.2.7 2016/05/06 14:40:59 /home/hosting_users/nkmed/www/rev_template/view/online/index.tpl 000003844 */ ?>
<!docType html>
<html lang="ko">
<head>
...
<form name="r_form" id="r_form" method="post">
	...
	<input type="hidden" name="kakao_token" id="kakao_token">    
		...
		function getKakaotalkUserProfile(){
			Kakao.API.request({
				...
				success: function(res) {
					...
					$("#r_id").val(res.id);
					$("#kakao_token").val(Kakao.Auth.getAccessToken());						
