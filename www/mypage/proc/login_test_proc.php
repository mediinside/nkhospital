	...
	switch($mode){
		...
		case 'naver':
			...
			if($rst["cnt"] == 0){
				...
				?>
						<script>
						opener.top.location.href = 'http://nkhospital.net/m/main.html';
						setTimeout(function(){
								self.close();
						},300);
					</script>	
		...
		case 'kakao':
			...
			if($rst["cnt"] == 0){
				...
				?>
					<!-- <script>
						window.top.location.href = 'http://nkhospital.net/m/user.info.html';
						/*setTimeout(function(){
								self.close();
						},300);*/
					</script> -->
				...
				?>
				<!-- 		<script>
						window.top.location.href = 'http://nkhospital.net/m/main.html';
						/*setTimeout(function(){
								self.close();
						},300);*/
											</script>	 -->
				<?php
						...
						$C_Func ->	put_and_parent("http://nkhospital.net/m/main.html");
					}
				} 
