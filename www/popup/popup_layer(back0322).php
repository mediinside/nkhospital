...
<script type="text/javascript">
	...
	<div id="divpop_<?=$pop_idx?>" style="width:<?=$pop_width?>px; height:<?=$pop_height?>px; position:absolute; left:<?=$pop_x_position?>px; top:<?=$pop_y_position?>px; z-index:10000; visibility: hidden; overflow:<?=$scrollbars?>;">
