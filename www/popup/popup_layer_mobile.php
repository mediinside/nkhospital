...
<script type="text/javascript">
	...
	for($i=0; $i<count($rst); $i++) {
		...
		if ($pop_type=="T") {
				...
				$pop_str = "<div style='width:90%;background-color:#CCC;'>" . $pop_str ."</div>";
		}else{
	...
	<div id="divpop_<?=$pop_idx?>" class="popup-layer" style="width:100%;position:absolute; left:0px; top:100px; z-index:10000; visibility: hidden; overflow:<?=$scrollbars?>;">
