$(document).ready(function(){
	...
	$.validator.addMethod("DoubleCheckEmail", function(mb_email) {
	...
	$('#frmJoin').validate({
		rules: {
			...
			mb_email: { required:true, emailcheck:true, DoubleCheckEmail:true },
		...
		submitHandler: function(frm) {
			if (!confirm("가입 하시겠습니까?")) return false;
				frm.action = '/v3/controller/action/join_action.php';
				frm.submit(); //통과시 전송
				return true;
		},
