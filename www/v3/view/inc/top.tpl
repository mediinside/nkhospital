			...
			<div id="gnb">
				...
				<nav class="menuNav">
					...
					<ul class="menuList">
						...
						<li><a href="#">진료과/의료진<span>({ctotal})</span></a>
							<ul class="subMenu">
								<li><a href="#" onclick="subMenu(this); return false;">전문센터 <span>(<?=count({gpa})?>)</span></a>
								...
								<li><a href="#" onclick="subMenu(this); return false;">진료과 <span>(<?=count({gpb})?>)</span></a>
									<ul class="subMenu2 typeDiv">
	                                    <!--{@gpb}-->
								...
								<li><a href="#" onclick="subMenu(this); return false;">특수클리닉 <span>(<?=count({gpc})?>)</span></a>
									<ul class="subMenu2">
										<!--{@gpc}-->
