<?php /* Template_ 2.2.8 2019/06/13 22:56:33 /home/hosting_users/nkmed/www/v3/view/agree/terms.tpl 000017468 */ ?>
<h2 class="pageTitle terms">이용약관</h2>
			<div class="section">
...
본 약관은 의료법인 인봉의료재단 뉴고려병원(이하 “병원”이라고 한다)에서 운영하는 인터넷 홈페이지에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)의 이용에 관한 사항을 규정함을 목적으로 합니다. 


ο 제2조(정의) 
이용자(회원) 
인터넷 홈페이지에 로그인하여 본 약관에 따라 병원이 제공 하는 서비스를 받는 자를 말합니다.
운영자
서비스의 전반적인 관리와 원활한 운영을 위하여 병원에서 선정한 사람 

연결사이트
홈페이지와 하이퍼링크 방식(하이퍼링크의 대상에는 문자, 정지 및 동화상 등이 포함됨) 등으로 연결된 웹 사이트를 말합니다. 

개인정보
당해 정보에 포함되어 있는 성명, 주민등록번호 등의 사항에 의하여 특정 개인을 식별할 수 있는 정보(당해 정보만으로는 특정 개인을 인식할 수 없더라도 다른 정보와 용이하게 결합하여 식별할 수 있는 것을 포함한다)를 말합니다.

해지
이용자가 서비스 개통 후 이용계약을 해약하는 것 
...
병원은 제1항의 사유로 서비스 제공이 일시적으로 중단됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여는 배상하지 아니합니다.
...
ο 제7조 (회원 탈퇴 및 자격의 상실등)

회원은 병원에 언제든지 탈퇴를 요청할 수 있으며 병원은 즉시 회원탈퇴를 처리합니다. 단, 탈퇴의 요청시 해지사유를 기재하여야 합니다. 회원이 다음 각호의 사유에 해당하는 경우, 병원은 회원자격을 상실시킬 수 있습니다.

-등록 신청 시에 허위 내용을 등록한 경우
-다른 사람의 서비스 이용을 방해하거나 그 정보를 도용하는 등 질서를 위협하는 경우
-병원 내에서 검증되지 않은 허위정보 및 기타 허락되지 않은 물품의 판 매 행위를 하는 경우
...
3. 병원의 승낙 통지가 이용자의 전자우편으로 도달된 때에 예약이 성립된 것으로 봅니다.
...
ο 제13조(개인정보의 보유기간 및 이용기간)

병원은 회원 자격을 가지고 있는 기간을 개인정보의 보유기간 및 이용기간으로 정합니다.


ο 제14조(개인정보의 이용 및 제공의 제한)
...
3. 통계작성·학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인 을 식별할 수 없는 형태로 제공하는 경우
...
병원은 이용자의 상담 내용이 상담의사를 제외한 제3자에게 유출되지 않도록 최선을 다해 보안을 유지하려고 노력합니다.
다만, 다음 각호의 사유로 인하여 상담 내용이 공개 또는 훼손된 경우 병원은 책임을 지지 않습니다.

1. 사용자의 부주의로 비밀번호가 유출된 경우
2. 사용자가 '상담삭제' 기능을 사용한 경우
3 사용자가 ‘상담공개’ 기능을 사용한 경우
...
ο 제17조 (건강관련정보 제공 서비스)

1.병원에서 제공하는 건강관련정보는 개략적이며 일반적인 것으로서 특정인의 의견에 지나지 않으며 어떠한 경우에도 전문적인 의학적 진단, 진료, 치료를 대신할 수 없습니다.
2.병원은 건강관련정보제공서비스에서 언급된 어떠한 특정한 검사나 제품 또는 치료법을 보증하지 않습니다.
3.병원은 제공하는 건강관련정보는 전적으로 이용자의 판단에 따라 이용되는 것으로서, 병원은 건강관련정보의 제공과 관련하여 어떠한 책임도 지지 않습니다.


ο 제18조 (병원과 연결 사이트간의 관계)
...
ο 제20조 (이용자의 주민등록번호 및 비밀번호에 대한 의무)

-이용자는 병원을 이용하는 경우 주민등록번호 및 비밀번호를 사용해야 합니다.
