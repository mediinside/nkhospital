<?php /* Template_ 2.2.8 2019/06/13 15:36:54 /home/hosting_users/nkmed/www/v3/view/mypage/mypage.tpl 000003621 */ ?>
<?php $this->print_("mymenu",$TPL_SCP,1);?>
    ...
    <fieldset>
        ...
        <table class="joinInputTable">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" class="inputTxt" readonly value="<?php echo $TPL_VAR["id"]?>" id="mb_id">
                    </td>
                </tr>
                <tr>
                    <th scope="row">이름<span class="essential">*</span></th>
                    <td>
                        <input type="text" class="inputTxt" readonly value="<?php echo $TPL_VAR["name"]?>">
                    </td>
                </tr>
                <tr>
                    <th scope="row">이메일</th>
                    <td class="btnOn">
                        <input type="text" class="inputTxt" value="<?php echo $TPL_VAR["email"]?>" id="mb_email">
                ...
                <tr>
                    ...
                    <td class="btnOn">
                        <input type="phone" class="inputTxt" value="<?php echo $TPL_VAR["mobile"]?>" id="mb_mobile">
        ...
        <table class="joinInputTable">
            ...
            <tbody>
            	<input type="hidden" id="mb_code" value="<?php echo $TPL_VAR["mcode"]?>"/>
                <tr>
