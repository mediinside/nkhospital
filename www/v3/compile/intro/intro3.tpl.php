<?php /* Template_ 2.2.8 2019/06/13 14:33:23 /home/hosting_users/nkmed/www/v3/view/intro/intro3.tpl 000004711 */ ?>
<?php $this->print_("introtop",$TPL_SCP,1);?>

<div class="section">
	<p class="decoTxt">뉴고려병원이 걸어온 길, <br> 그리고 주요 연혁입니다.</p>
    <section class="hospHistory">
        <h2 class="title">2018 ~ 2016</h2>
        ...
        <script>historySlide('historySlide1');</script>
        <ul class="list">
            <li>
                <b class="year">2018</b>
                경기도 지정 지역응급의료센터 승격<br>
                진료의뢰회송 시법사업 기관 선정<br>
                응급의료기관평가 경기도 전체 1위
            </li>
            <li>
                <b class="year">2017</b>
    ...
    <section class="hospHistory">
        ...
        <script>historySlide('historySlide2');</script>
        <ul class="list">
            <li>
                <b class="year">2015</b>
                국가지정 메르스 국민안심병원 지정<br>
                간호간병통합서비스 병동 운영(5병동 48병상)<br>
                혈관조영건수 1,000 case 돌파
            </li>
            <li>
                <b class="year">2014</b>
                인공신장센터 개소<br>
    ...
    <section class="hospHistory">
        ...
        <script>historySlide('historySlide3');</script>
        <ul class="list">
            <li>
                <b class="year">2009</b>
                병상 증설(245병상)<br>
                뉴고려병원 완공 및 진료 개시(201병상)
            </li>
            <li>
                <b class="year">2008</b>
                뉴고려병원 건축 착공
