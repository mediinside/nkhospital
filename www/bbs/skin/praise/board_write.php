					...
					<table width="100%" class="writeType">
						...
						<tbody>
							...
							<tr>
								<th scope="row">구분</th>
								<td>
									<? echo $treat_select = $C_Func -> makeSelect_Normal('jb_treat', $GP -> CLINIC_TYPE_NEW, $jb_treat, ' style="border:1px solide #ddd; height:27px; line-height:27px;" ', '::선택::');?>
								</td>
							</tr>							
							<tr>
								<th scope="row">작성자</th>
								<td>
									<input type="text" class="txtInput" style="width:228px;" id="jb_name" value="" name="jb_name" value="<?=$check_name?>" />
								</td>
							</tr>							
							<tr>
								<th scope="row">이메일</th>
								<td>
									<input type="text" class="txtInput" id="jb_email" name="jb_email" value="" style="width:578px;" />
								</td>
							</tr>
                            <?php
							...
							<tr>
								...
								<td>
									<input type="text" class="txtInput" style="width:578px;" id="jb_homepage" name="jb_homepage" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<img src="/bbs/zmSpamFree/zmSpamFree.php?zsfimg=1603706232" id="zsfImg"
										alt="아래 새로고침을 클릭해 주세요." />
									<input type="text" id="zsfCode" class="txtInput" name="zsfCode" maxlength="10" size="8">
									<a title="새로고침" href="#"
										onclick="document.getElementById('zsfImg').src='/bbs/zmSpamFree/zmSpamFree.php?re&zsfimg=' + new Date().getTime(); return false;">새로고침</a>
								</td>
							</tr>
						</tbody>
					</table>
