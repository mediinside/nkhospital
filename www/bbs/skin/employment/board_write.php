	...
	<div class="txtR"><span>*</span> 필수입력</div>
      ...
      <tbody>
        ...
        <tr>
            <th>게시기간</th>
            <td>
            <input type="text" class="i-inputpop " size="15" name="jb_etc1" id="jb_etc1" />
								 ~ 
								<input type="text" class="i-inputpop " size="15" name="jb_etc2" id="jb_etc2" /> <input type="checkbox" name="jb_etc2_chk" value="채용시까지">채용시까지
            </td>
        </tr>
        <tr>
