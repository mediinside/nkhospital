...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
        ...
        <button id="excel_btn" value="EXCEL" class="btnSearch ">엑셀 출력</button>
		<button onClick="layerPop('ifm_reg','./nonpay_reg_new.php', 500, 600)"; class="btnSearch ">비급여 등록</button>
		</div>
						...
						<tbody>
							<?
								...
								for ($i = 0 ; $i < $data_list_cnt ; $i++) {
									...
									$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./nonpay_edit_new.php?np_idx=" . $np_idx. "', 500, 600)", 50,'');	
