...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        gridcontainer.css("overflow-y", "visible").height(option.height - 8);
				//수정 2014-02-20
				//gridcontainer.css("overflow-y", "visible").height(option.height - 133);
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            if (l == 1) {
                ...
                option.vend = days[0].date;
								option.jstart = toDateString(days[0].date);
								option.jend = toDateString(days[0].date);
            }
            else {
                var w = 0;
                if (l == 7) {
                ...
                option.datestrshow = CalDateShow(days[0].date, days[l - 1].date);
								option.jstart = toDateString(days[0].date);
								option.jend = toDateString(days[l - 1].date);
            }
        ...
        function BuildMonthView(showday, events, config) {
            ...
            var bH = GetMonthViewBodyHeight() - (GetMonthViewHeaderHeight() - 20);
						//수정 2014-02-20
						//var bH = GetMonthViewBodyHeight() - (GetMonthViewHeaderHeight() * 7);
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
            ...
            for (var i = 0; i < l; i++) {
                ...
                // Today
                if (istoday) {
                    ht.push("<div style=\"margin-bottom: -2016px; height:2016px\" class=\"tg-today\">&nbsp;</div>");
                }
								
                //var eventC = $(eventWrap);
                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
                ht.push("<div  style=\"margin-bottom: -2016px; height: 2016px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
                ...
                ht.push("<div class=\"tg-col-overlaywrapper\" id='tgOver", i, "'>");
								...
								//2014-02-28 전형 today 현재시간 경계 표시긴한데 안이뻐서 뺌
								/*
                if (istoday) {
                    var mhh = mHg + 4;
        ...
        function BuildDayEvent(theme, e, index) {
            ...
            p.endtime = pZero(e.et.hour) + ":" + pZero(e.et.minute);
						...
						//20140213 jeon hyoung e.event[9] - 상품 노출 같이 추가
            p.content = e.event[1] + " - " + e.event[9]; 								
        ...
        function BuilderMonthBody(htb, showday, startday, events, bodyHeight) {
            ...
            option.vend = enddate;
						option.jstart = toDateString(startdate);
						option.jend = toDateString(enddate);
            ...
            if (rowheight % 21 > 15) {
                roweventcount++;
						...
						*/
						var roweventcount = parseInt(rowheight / 41);
            if (rowheight % 41 > 15) {
                roweventcount++;
            }
            var p = 100 / rc;
        ...
        function tc(d) {
            function zc(c, i) {
										...
										*/
										var d = "be6d00ee8800f2a640f7c480fadcb37a367a994499b373b3cca2cce1c7e12952a33366cc668cd999b3e6c2d1f00d78131096184cb05288cb8cb8e0bab1440edd5511e6804deeaa88f5ccb84e5d6c6274878997a5b1bac3d0d6dba32929cc3333d96666e69999f0c2c2";
        ...
        function CalDateShow(startday, endday, isshowtime, isshowweek) {
            if (!endday) {
				...
				//2014-02-28 전형 날짜 포맷변경위해 yyyy-mm-dd
        ...
        function buildtempdayevent(sh, sm, eh, em, h, title, w, resize, thindex) {
            var theme = thindex != undefined && thindex >= 0 ? tc(thindex) : tc();		
						...
						/*
						var info = '';
						 for (var imsi in theme) {
						 info += imsi + ' = ' + theme[imsi] + '\n';
						 }
						alert(info);
						*/
						//console.log(w);
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	...
                    	+ i18n.xgcalendar.update_detail + '</SPAN></div></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose2" class="bubble-closebutton"></div><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
                    ...
                    var ts = $("#bbit-cs-buddle-timeshow").html(ss.join(""));
										...
										//2014-02-25 상세보기 풍선말 속 내용 추가
                    $("#bbit-cs-what").html(data[1] + " - " + data[9]);
        ...
        function quickadd(start, end, isallday, pos) {
            if ((!option.quickAddHandler && option.quickAddUrl == "") || option.readonly) {
                return;
						...
						//2014-02-27 추가 상품 리스트
						var sel_data = "<select id='bbit-cal-product'><option value=''>:::선택:::</option></select>";						
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/>&nbsp;<input type="button" value="회원찾기" onclick="layerPop_new(\'iframset\',\'./mem_search.php\', 550, 400)" /><span class="cb-example">');
                temparr.push(i18n.xgcalendar.example, '</span></div></div></td></tr><tr><th class="cb-key">');
								temparr.push(i18n.xgcalendar.product, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid">' + sel_data + '<span class="cb-example">');								
								/*
								temparr.push(i18n.xgcalendar.product, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-product" class="textbox-fill-input"/><span class="cb-example">');	
								*/
								temparr.push(i18n.xgcalendar.example1, '</span></div></div></td></tr><tr><th class="cb-key">');
								temparr.push(i18n.xgcalendar.mobile, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-mobile" class="textbox-fill-input"/><span class="cb-example">');						 
								temparr.push(i18n.xgcalendar.example2, '</span></div></div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');	
								
								
                temparr.push(i18n.xgcalendar.create_event, '" type="button"/>&nbsp;<input id="bbit-cal-editLink" value="');
                temparr.push(i18n.xgcalendar.update_detail,'" type="button"/>&nbsp;</div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div><input type="hidden" name="mb_code" id="mb_code" /><input type="hidden" name="mb_name" id="mb_name" />');
                var tempquickAddHanler = temparr.join("");
                temparr = null;
                $(document.body).append(tempquickAddHanler);								
								
								//2014-02-27 전형 추가 상품 리스트
								$.post(option.quickProductUrl, param, function(data) {
										if (data) {
												if (data.IsSuccess == true) {											
													var tmparr = data.data;											
													$.each(tmparr, function(i) { 														
															$('#bbit-cal-product').append("<option value='" + tmparr[i]['pd_idx'] + "'>" + tmparr[i]['pd_name'] + "</option>");													
													});	
												}
										}
								}, "json");		
                ...
                calbutton.click(function(e) {
                    ...
                    var allday = $("#bbit-cal-allday").val();
										var product = $("#bbit-cal-product option:selected").val() + ":" + $("#bbit-cal-product option:selected").text();
										var product_txt = $("#bbit-cal-product option:selected").text();
										var mobile = $("#bbit-cal-mobile").val();
                    ...
                    var param = [{ "name": "CalendarTitle", value: what },
																	...
																	{ "name": "timezone", value: zone},
																	{ "name": "CalendarProduct", value: product},
																	{ "name": "mb_code", value: mb_code},
																	{ "name": "mb_name", value: mb_name},
																	{ "name": "mr_mobile", value: mobile}
																	];
                    ...
                    if (option.quickAddHandler && $.isFunction(option.quickAddHandler)) {
                        ...
                        $.post(option.quickAddUrl, param, function(data) {
                            if (data) {
                                if (data.IsSuccess == true) {
                                    option.isloading = false;
                                    option.eventItems[tId][0] = parseInt(data.Data);			//mysql_insert_id																		
                        ...
                        newdata.push(-1, 0, product_txt, ""); 	//2014-02-25 new event후 새로고침 데이터 보여주기 - 전형
        ...
        function ResizeView() {
            ...
            if (_viewType == "day" || _viewType == "week") {
                ...
                var calH = option.height - 8 - dvwkH;
								//수정 2014-02-20
								//var calH = option.height - (dvwkH * 4);								
                $dvtec.height(calH);		
            ...
            if (viewtype == "week" || viewtype == "day") {
                    ...
                    if (chip.hasClass("drag")) {
                        chip.mousedown(function(e) { 																								
														dragStart.call(this, "dw3", e); return false; 
												});
												//resize  
												/*
                ...
                switch (d.type) {
                    case 1:
                        ...
                        if (diffy > 11 || diffy < -11 || d.cpwrap) {
                            ...
                            var dy = diffy % 41;
                            if (dy != 0) {
                                diffy = dy > 0 ? diffy + 41 - dy : diffy - 41 - dy;
                                y = d.sy + diffy;
                                if (diffy < 0) {
                                    sy = sy + 41;
                                }
