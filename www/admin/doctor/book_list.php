...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer boxSearchMember">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>저서 및 논문 리스트</strong></span>
		</div>
		<form id="frm_find" name="frm_find" method="post">
		<div class="boxContentBody">			
			<div class="boxMemberInfoTable_layer">
				<ul class="mem_search_pop">					
					<li><button id="img_reg" class="btnSearch">저서 및 논문 리스트</button></li>					
				</ul>	
								...
								<tbody>
									<?
										...
										for($i=0; $i<$data_list_cnt; $i++) {
											...
											$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./book_edit.php?tb_idx=" . $tb_idx. "', 1150, 600)", 50,'');	
											$edit_btn .= $C_Button -> getButtonDesign('type2','삭제',0,"book_delete('" . $tb_idx. "')", 50,'');
										?>
										<tr>
											<td style="text-align:center;"><?=$data['page_info']['start_num']--?></td>
											<td style="text-align:center;"><?=$tb_title?></td>
											<td style="text-align:center;"><?=$tb_regdate?></td>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#img_reg').click(function(){		
				layerPop('ifm_reg','./book_reg.php?dr_idx=<?=$_GET['dr_idx']?>', 1150, 600)																 	
				return false;
		});
