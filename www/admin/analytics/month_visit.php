<?php
	...
	*/
	...
	$data = "";
	print_r($args);
	$data = $C_Analytics->Analytics_Month_List(array_merge($_GET,$_POST,$args));
		...
		<div id="BoardHead" class="boxBoardHead">				
				<div class="boxMemberBoard">
					 <ul class="analysis_tot">
						...
						<li>일간접속수 : <span><?PHP if($data_list_cnt != 0) echo round($arr_tmp[1] / $data_list_cnt)?></span></li>
					 </ul>
						<table>
							<colgroup>
							<col width="120px"></col>     
							...
							<tbody>
								<?
										$dummy = 1;
										for ($i = 0 ; $i < $data_list_cnt ; $i++) {
											$StatusDay 		= $data_list[$i]['StatusDay'];
