					...
					<table>
						...
						<tbody>
							...
							for ($i = 0 ; $i < $data_list_cnt ; $i++) {
								...
								$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./bbs_edit.php?jb_code=" . $jb_code. "', '100%', 650)", 25,'');						
								$edit_btn .= $C_Button -> getButtonDesign('type2','관리',0,"javascript:BoardAdminWin(" . $jb_code .")", 25,'');									
							?>
									<tr>
