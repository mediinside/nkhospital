...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		...
		<input type="hidden" name="ts_type" id="ts_type" value="M" />
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								...
								<td>
									<label>
										<input type="radio" name="ts_gubun" value="T" checked /> 상단
									</label>
									<label>
										<input type="radio" name="ts_gubun" value="M"/> 메인
									</label>
								</td>
							</tr>                           							
							<tr>
								...
								<td>
									<input type="file" name="ts_m_img" id="ts_m_img" size="30" class="input_text"> 상단 : (720*200)  / 메인 : (720*620)
								</td>
							</tr>
						</tbody>
					</table>
