...
#예약 체크
	...
	$chk_query = "select * from reserve_list_new where view_state='Y' $where 
	union all 
	select * from reserve_list_new_jian where view_state='Y' $where
	...
	?>
				<tr align="center" bgcolor="#FFFFFF">
					<td><?=$no?></td>
					<td><?if($chk_rows['sort']=="지안"){echo "지안";}else{echo "나은";}?></td>
