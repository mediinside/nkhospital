...
if($mode == "update" && $seq) {
	$que = "update reserve_list_new set reserve_type='".$reserve_type."', jumin_no='".$jumin_no."', mobile_no='".$mobile_no."', email='".$email."', reserve_place='".$reserve_place."',  reserve_name='".$reserve_name."',  reserve_name2='".$reserve_name2."',  reserve_name3='".$reserve_name3."', comment='".$comment."' where seq='".$seq."'";
