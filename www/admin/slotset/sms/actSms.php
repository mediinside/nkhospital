...
for ($i = 2; $i <= $data->sheets[0]['numRows']; $i++) {
	...
	$pass_day = "";
	$post1 = substr($data->sheets[0]['cells'][$i][17],0,3);
	$post2 = substr($data->sheets[0]['cells'][$i][17],3,3);

	$jumin_no = substr($data->sheets[0]['cells'][$i][14],0,6)."-".substr($data->sheets[0]['cells'][$i][14],6,7);
