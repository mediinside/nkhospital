...
<div id="MAIN" style="padding:10 10 10 10">
	<div class="box"><b>SMS 문자 보내기</b></div>
		...
		<div class="rtoutLRline">
			...
			<tr bgcolor='#EEEEEE'>
				...
				<td bgcolor='#FFFFFF' style='padding : 5 0 5 5' colspan='3'>
					<input type="radio" name='condition' value='all' onFocus='this.blur();' onClick="selectCondition(this.value)">전체발송
			...
			<tr id='ALL' bgcolor='#EEEEEE' style='display:none'>
				<td width='70' style='padding : 5 0 5 5'>엑셀 파일 첨부</td>
				<td width='520' bgcolor='#FFFFFF' style='padding : 5 0 5 5'>
					<input type="file" value="sms_excel">
				</td>
			</tr>
			...
			<tr>
				<td colspan="4" bgcolor="white" align="center" style="padding-bottom:5px">
					<div align="center">
						...
						<div style="margin-top:10px"><textarea name="content" style="width:140; height:80" class="textfield" onKeyUp="chkLen(40,this);" onChange="chkLen(40,this);"></textarea>
						<div id="msglen" class='font_small'>0 / 80 Byte</div></div>
						<div style="margin-top:10px" class='font_small'> 회신번호 <input type="text" style='width:85px;' class="textfield" value='18778891' name="from"></div>
