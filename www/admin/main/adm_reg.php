	...
	*/	
		...
		$('#base_form').validate({
			...
			messages: {	
				...
				mb_password: { required: "패스워드를 입력하세요",/* minlength: $.format("비밀번호는 {0}자 이상 입력하시오"),*/ maxlength: $.format("비밀번호는 {0}자 이상 입력할수 없습니다"),alphanumeric : $.format("영문(소)과 특수문자,숫자를 조합하세요.")},
