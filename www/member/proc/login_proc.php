    ...
    switch($mode){
		...
		case "LOGIN":
			...
			if($rst['mb_password'] ==  md5(trim($m_pwd))) {
                ...
                $_SESSION['suserbirth'] = $rst['mb_birth'];
                ...
                $_SESSION['susergubun'] 	= $rst['mb_gubun'];
                 $_SESSION['susermemo'] 	= $rst['mb_memo'];
        ...
        case 'naver':
			...
			/*if(empty($mb_name) || empty($mb_email)){
            	$naver->logout();
                $C_Func->put_msg_top_go_url('필수정보 제공 동의를 하셔야 가입이 가능합니다.',$GP -> SERVICE_DOMAIN . "/"); 
				exit;
            }*/
