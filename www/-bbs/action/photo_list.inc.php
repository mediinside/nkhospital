...
if($data_list_cnt > 0) {
	for ($i=0; $i<$data_list_cnt; $i++ ) {		
			...
			$jb_title_ori 	= $C_Func->strcut_utf8($data_list[$i]['jb_title'], 52, "...");	//제목 (길이, HTML TAG제한여부 처리)
			...
			{	
				...
				$img_src = "<img src='" . $code_file. "' alt='" . $jb_title_ori . "' width='148' height='98'>";	
            }
            else
            {
                $img_src = "<img src='' alt='" . $jb_title_ori . "' width='148' height='98'>";	
            }
          //  echo "echo:" . $jb_title_ori . "<br>" ;
?>
	<li <?=$td_class?>>
		<a href="<?=$get_par?>">
