...
<fieldset>
	...
	<table width="100%" class="writeType">
		...
		<tbody>
			<tr>
				<th scope="row">제 목</th>
				<td colspan="3"><input type="text" class="txtInput" style="width:578px;" id="jb_title" name="jb_title" value="<?=$jb_title;?>" /></td>
			</tr>
			<tr>
				<th scope="row">칭찬대상</th>
				<td><input type="text" class="txtInput" style="width:228px;" id="jb_praise_name" name="jb_praise_name" value="<?=$jb_praise_name;?>" /></td>
				<th scope="row">소속</th>
				<td><? echo $treat_select = $C_Func -> makeSelect('jb_treat', $GP -> CLINIC_TYPE_NEW2, $jb_treat, ' class="selType" ', '::선택::');?></td>
			</tr>
			<tr>
				<th scope="row">작성자</th>
				<td colspan="3"><input type="text" class="txtInput" style="width:228px;" id="jb_name" value="<?=$jb_name?>" name="jb_name" /></td>
			</tr>					
      <!--tr>
