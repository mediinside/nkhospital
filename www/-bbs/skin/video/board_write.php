...
<fieldset>
	...
	<table width="100%" class="writeType">
	  ...
	  <tr>
			...
			<td width="85%">
				<input type="text" class="txtInput" name="vd_link1" id="vd_link1" style="width:578px;"/>
			</td>
		</tr> 
			<tr>
      ...
      <tr>
        ...
        <td>
					<ul>
						...
						?>
							<?=$filetext?> <input type="file" name="jb_file[]" class="fileInput">
						<? } ?>
						</li>
					</ul>
       </td>
	...
	<div class="btn-group">
        ...
        echo "<a class='btn btn-normal' href=\"#\" onclick=\"javascript:location.href='${index_page}?jb_code=${jb_code}&${search_key}&search_keyword=${search_keyword}&page=${page}'\" title='목록보기'><span>목록</span></a>";						
			...
			<a class='btn btn-red' href="javascript:;" id="img_submit"  class="bgGray"><span>글쓰기</span></a> 
		</div>
	</div>
</fieldset>
