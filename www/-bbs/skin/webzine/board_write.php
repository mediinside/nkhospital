...
<? 
	$web_select = $C_Func -> makeSelect_Normal('jb_type', $GP -> WEBZINE_TYPE, $_GET['jb_type'], ' title="카테고리"  ', '카테고리','');
	$sel_webzine = $C_Func->makeSelect_Normal('jb_webzine1', $GP -> WEBZINE_YEAR , $jb_webzine1, "'",'선택');
	$sel_webzine2 = $C_Func->makeSelect_Normal('jb_webzine2', $GP -> WEBZINE_MONTH , $jb_webzine2, "'",'선택');
?>
	...
	<table width="100%" class="writeType">
		...
		<tbody>
            ...
            <tr>
             ...
             <tr>
              <th scope="row">웹진 호</th>
              <td> <?=$sel_webzine?>	년 <?=$sel_webzine2?>	월
              </td>
            </tr>
			<tr>
				<th scope="row">작성자</th>
      ...
      <tr>
        ...
        <td>
					<ul>
						...
						for($i=0; $i<1; $i++) {
						?>
							<input type="file" name="jb_file[]" class="fileInput">(570 X 374)
						<? } ?>
						</li>
					</ul>
       </td>
