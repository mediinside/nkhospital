...
<?php $web_select = $C_Func -> makeSelect('jb_type', $GP->WEBZINE_TYPE, $jb_type, '','선택하세요');
	   $arr_web = explode("-", $jb_webzine);
	   $jb_webzin1 = $arr_web[0];
	   $jb_webzin2 = $arr_web[1];
	   $sel_webzine = $C_Func -> makeSelect('jb_webzine1', $GP->WEBZINE_YEAR, $arr_web[0], '','선택하세요');
	   $sel_webzine2 = $C_Func -> makeSelect('jb_webzine2', $GP->WEBZINE_MONTH, $arr_web[1], '','선택하세요');
?>
