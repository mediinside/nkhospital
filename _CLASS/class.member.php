...
{	
	...
	function sendMail($args)
	{
		...
		if ($sender_email && $sender_name && $receive_email && $receive_name && $email_subject) {
			...
			$mailFormDir = @file_get_contents($this -> GP -> HOME."mypage/mem_find_pw_search.html");
	...
	function membersFindInfo ($args) {
		...
		//탈퇴 회원은 제외
		$qry = "Select mb_code, mb_email, mb_name From tblMember Where mb_id = '$mb_id' and mb_name = '$mb_name' And mb_del_flag = 'N' and mb_status='M' ";
	...
	function membersFindInfoNew ($args) {
